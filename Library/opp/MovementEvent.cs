...
namespace opp
{
	...
	{
		[XmlElement(Order=0)]		public infra.DirTrackEdgePoint? position {get;set;}
		[XmlArray(Order=1)]
		...
		[XmlElement(Order=3)]		public infra.LinkedPath? trackPathToNextEvent {get;set;}
		[XmlElement(Order=4)]		public opp.StopDescription? stopDescription {get;set;}
		[XmlAttribute("id")]
